...
export default function SuperAdminSettings() {
  const [general, setGeneral] = useState<GeneralSettings>({ academyName:'Masterview Digital Innovation Academy', tagline:'Become a Job-Ready Digital Professional', address:'24 Ada George Road, Port Harcourt, Rivers State', email:'hello@masterviewacademy.com', phone:'+234 (0) 800 000 0000' })
